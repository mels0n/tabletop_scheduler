...
**Global AEO rules apply CONDITIONALLY based on deployment mode:**

1. **HOSTED Mode (`NEXT_PUBLIC_IS_HOSTED=true`):**
   - **Mandate:** Full AEO. Apply all Schema.org, Sitemap, and Metadata rules from `/.GEMINI.md`.
   - **Goal:** Maximize discoverability and public indexing.

2. **SELF-HOSTED Mode (`IS_DOCKER_BUILD=true`):**
   - **Mandate:** Privacy First. **OVERRIDE** global AEO rules regarding indexing.
   - **Enforcement:**
