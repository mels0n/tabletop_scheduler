---
title: "How to Draft Magic: The Gathering With Friends at Home (Complete Guide)"
description: "Everything you need to run an MTG booster draft at home — the right Play Booster box, land station setup, table prep, the snack rule everyone ignores, and how to actually get your friends to show up."
date: "2026-04-22"
tags: ["MTG", "Magic The Gathering", "Draft", "Game Night", "Card Games", "Scheduling"]
itemList: ["Play Booster Box (newest set — 36 packs)", "Basic land station: Plains, Island, Swamp, Mountain, Forest (20+ of each)", "Large table — minimum 6 feet per pod of 8", "Card sleeves (draft sleeves work fine)", "Dice or counters for life totals", "Side table for food and drinks", "TabletopTime.us event — set quorum to 4 or 8"]
listTitle: "Home Draft Checklist"
faq:
  - question: "How many people do you need to draft Magic: The Gathering?"
    answer: "A standard MTG draft pod is 8 players, though you can draft with as few as 4. With 4-7 players, each person still opens 3 packs and drafts normally — the card pool is just smaller. 8 players gives you the cleanest pod experience with the most balanced card circulation."
  - question: "What booster packs do you need to draft Magic: The Gathering at home?"
    answer: "You need Play Booster packs — not Set Boosters or Collector Boosters, which aren't designed for draft play. A Play Booster Box contains 36 packs, enough for one pod of 8 (each player opens 3 packs) or two pods of 4. Get the newest set available for the freshest limited environment."
  - question: "What is a land station for MTG draft?"
    answer: "A land station is a shared supply of basic lands that all players draw from when building their 40-card draft decks. It must include all five basic types: Plains (white), Island (blue), Swamp (black), Mountain (red), and Forest (green). Keep at least 20 of each, placed in the center of the table so everyone can reach it during deck construction."
  - question: "Should you eat at the Magic: The Gathering table?"
    answer: "No. Set up food and drinks on a side table away from the draft area. Greasy fingers and spilled drinks ruin cards — and in a draft, other people's cards too. Put snacks out between rounds, not during gameplay, and keep drinks in sealed cups or cans at the side table only."
  - question: "How do I schedule an MTG draft with friends?"
    answer: "Use Tabletop Time to create a free event, set the player minimum to 4 or 8 (depending on how many pods you want), and share the link with your playgroup. The quorum feature highlights which dates have enough confirmed players for a real draft pod, so you don't commit to a night that falls apart."
  - question: "How do you draft Magic: The Gathering at home step by step?"
    answer: "1. Get a Play Booster Box of the newest set. 2. Set up a land station with 20+ of each basic land type in the center of the table. 3. Give each player 3 sealed booster packs and a seat. 4. Draft simultaneously — open pack 1, pick 1 card, pass left. Repeat until packs are empty, then open pack 2 (pass right), then pack 3 (pass left). 5. Build a 40-card deck using drafted cards plus lands from the station. 6. Play 3 rounds of Swiss."
---
...
3. **Share the link** — paste it in Discord, Telegram, or your group chat. No one needs to create an account to vote.
4. **See the winner** — the scheduler flags which dates have enough confirmed players for the pod size you need
5. **Finalize** — everyone gets a calendar event automatically
